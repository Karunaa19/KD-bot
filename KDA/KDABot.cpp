...
class ChatBot {
    ...
    unordered_map<string, string> urlMapping = {
        ...
        {"assigment","https://github.com/karkikaruna/cpp-Assignment"},
        ...
        {" show me my syllabus", "https://drive.google.com/drive/folders/1k2wFsxbFKTXX6OcH1tFsNWOxCG5jjPAI"}
    };
        ...
        if (input == "yes") {
            ...
            cout << BLUE << "I'm sorry to hear that. If there's anything specific bothering you, let me know." << RESET<<endl;
                     ...
                     input.find("pdf")!=string::npos
                        ...
                        cout << BLUE<<"I am KDA-BOT, created by three undergraduate student during their college time as their first year project. "<<RESET<<endl;
                     ...
                     cout << BLUE<< "I was created by three computerEngineering student Karuna,Dipika and Aarzu as their first year project."<< RESET << endl;
                     string input;
                     getline(cin, input);
                     ...
                     input.find("information") != string::npos) {
                        cout << BLUE<< "They are undergraduate computer engineering student at IOE PURWANCHAL CAMPUS. Do you want to contact them?"<< RESET<<endl;
                        string answer;
                        getline(cin, answer);
                        transform(answer.begin(), answer.end(), answer.begin(), ::tolower);
